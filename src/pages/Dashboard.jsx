    ...
    <div className="animate-fade-in">
      <header className="flex items-center justify-between py-4">
        ...
        <button
          ...
          className="flex h-9 items-center gap-2 rounded-full bg-white px-3 text-sm font-medium text-ink-soft shadow-card lg:hidden"
        >
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-5 lg:col-span-2">
          ...
          <section className="overflow-hidden rounded-3xl bg-gradient-to-br from-brand-600 to-brand-800 p-6 text-white shadow-float lg:p-8">
            ...
            <p className="mt-1 text-4xl font-extrabold tracking-tight lg:text-5xl">{formatKes(data.totalLocked)}</p>
          ...
          <Link to="/app/new" className="btn-primary w-full lg:hidden">
...
function ScheduleCard({ s, muted }) {
  return (
    <Link
      ...
      className={`card block h-full p-4 transition hover:shadow-float active:scale-[0.99] ${muted ? 'opacity-90' : ''}`}
    >
